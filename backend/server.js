...
app.post('/signup', async (req, res) => {
  ...
  try {
    ...
    if (username === '') {
      res.status(400).json({
        message: 'Validation failed: Please provide a username',
        response: error,
        success: false,
      });
      ...
      res.status(400).json({
        message: 'Validation failed: Please provide your email',
        response: error,
        success: false,
      });
    } else if (password === '') {
      res.status(400).json({
        message: 'Validation failed: Please provide a password',
        response: error,
        success: false,
      });
    } else {
      res.status(400).json({
        message:
          'Validation failed: Please provide username, email and password',
        response: error,
        success: false,
      });
    }
